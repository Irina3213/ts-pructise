...
// function makeMesage(username: string, login?: string): string | number {
//   if (login !== undefined) {
...
//   }
// }
// makeMesage("Oleg", "test");
// makeMesage("Tetiana");

// //типізація методів обєктів
...
//     this.products.push(product); //-poki vidae pomilky
